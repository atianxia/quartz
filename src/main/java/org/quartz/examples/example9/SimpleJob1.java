...
/*    */   implements Job
/*    */ {
/* 38 */   private static Logger _log = LoggerFactory.getLogger(SimpleJob1.class);
/*    */ 
/*    */   public void execute(JobExecutionContext context)
/*    */     throws JobExecutionException
/*    */   {
/* 61 */     JobKey jobKey = context.getJobDetail().getKey();
/* 62 */     _log.info("SimpleJob1 says: " + jobKey + " executing at " + new Date());
/*    */   }
/*    */ }

/* Location:           D:\Quartz\quartz-2.2.1-distribution\quartz-2.2.1\examples\lib\quartz-examples-2.2.1\
 * Qualified Name:     org.quartz.examples.example9.SimpleJob1
